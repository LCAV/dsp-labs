...
In [Chapter 3.1](effect_description.md), we will explain the effect that we will be implementing. In [Chapter 3.2](dsp_tips.md), we will discuss some important points that need to be considered when implementing real-time DSP. In [Chapter 3.3](python.md), we propose a Python framework for simulating a real-time environment with your laptop's sound card the [`sounddevice`](http://python-sounddevice.readthedocs.io/) library. Finally, we will guide you through the implementation on the STM32 board in [Chapter 3.4](implementation.md).
